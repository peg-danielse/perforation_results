...
RESULTS_DIR = os.path.join(os.getenv('RESULTS_ROOT'), 'perforation_performance', 'results')
OUTPUT_DIR = os.path.join(os.getenv("RESULTS_ROOT"), 'perforation_performance')
...
# main
benchmarks = compile_testdata("range_medium")
...
for func in (
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(OUTPUT_DIR, "perforation-performance_{}.pdf".format(func.__name__)))
    plt.clf()
